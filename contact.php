<html>
   ...
   ?>
	...
	<div id="abt"><h1 id="head">Contact Us</h1></div>
	<br>
	<hr>
	<p id="content"><b>MAILING ADDRESS</b><br><br>
		GamesCart Pvt. Ltd.,<br>
		401, Kanakia Western Edge - Phase 1,<br>
		Western Express Highway,<br>
		Borivali (E), Mumbai-400 066<br><br>
		<b>REGISTERED ADDRESS</b><br><br>
		GamesCart Retail Pvt. Ltd.,<br>
		708, Autumn Grove,<br>
		Lokhandwala Township, Akurli Road,<br>
		Kandivali (East), Mumbai - 400 101<br>
		Tel:+91-22-42612 101/139<br><br>
		<b>FOR ANY QUERIES CONTACT CUSTOMER CARE:</b><br><br>
		Call:022-42312147<br>
		(between 10am to 6pm from Mon-Fri except public holidays)<br>
		E-mail ID: helpdesk@gamesCart.com<br>
</p>
	<div id="footer">
