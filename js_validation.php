    ...
    <body background="FFFFFF">
      ...
      <div id="header">
		 ...
		 <div id="search">
		    ...
		    <form>
                 <input type="text" placeholder="Search for games,console,accessories and more..." required class="search">
	  ...
	  <div id="wrap">
	    ...
	    <iframe id="sideimg1"
		  img src="side6.png" width="100%"> 
		</iframe>
	<iframe id="sideimg2"
		   img src="side5.png" width="100%" >
		</iframe>
	      <div id="login1">
		  ...
		  <div id="login2">
		         <br>
		       <form class="form1" method="post" action="" onsubmit="return validateForm()" name="myForm">
				   ...
				   <br>
				   <br>
				   User ID: <input type="email" name="uid" required>
				   ...
				   <br>
				   <br>
				   Confirm Password: <input type="password" name="rpswd" required>
				   ...
				   <br>
				   <br>
				   Address line 1:<input type="text" name="ad1" required>
				   
				   <br><br>
				   Address line 2:<input type="text" name="ad2" required>
				   ...
				   <br><br>
				   Pin-code:<input type="text" name="pcode" required>
