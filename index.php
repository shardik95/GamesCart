		    ...
		    <ul class="navbar1">
                 ...
                 <li><a href="login.php">Login </a>
				      <ul>
						   ...
						   <li><a href="<?php echo $del ?>">Delete Account</a></li>
...
<div id="console">
	...
	<div class="container" style="box-shadow: 5px 7px 5px #888888;height:400px;">
...
(function(){
	 ...
	 <div id="main">
	   <div id="bar" >
		 ...
		 <a href="newreleases.php" class="a1">view more [+]</a>
	   </div>
	   <div id="bar1">
	   </div>
	     <table id="price">
	   <tr>
		...
		<tr>
		 ...
		 <table id="price">
		  <div id="bar">
	     <p id="pbar">Pre-order</p>
		 <a href="preorder.php" class="a1">view more [+]</a>
	   </div>
	   <div id="bar1">
	   </div>
		<tr>
	   <th><a href="Game.php?game_id=<?php echo "4";?>"><img src="<?php echo $img4;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "9";?>"><img src="<?php echo $img9;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "10";?>"><img src="<?php echo $img10;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "13";?>"><img src="<?php echo $img13;?>" width="auto" height="45%"></a></th>
		</tr>
		<tr>
	 	  <td><p class="p1"><b><?php echo $pc4;?></b><a class="buy" href="Game.php?game_id=<?php echo "4";?>">Pre-order</a></p></td>
		  <td><p class="p1"><b><?php echo $pc9;?></b><a class="buy" href="Game.php?game_id=<?php echo "9";?>">Pre-order</a></p></td>
		  <td><p class="p1"><b><?php echo $pc10;?></b><a class="buy" href="Game.php?game_id=<?php echo "10";?>">Pre-order</a></p></td>
		  <td><p class="p1"><b><?php echo $pc13;?></b><a class="buy" href="Game.php?game_id=<?php echo "13";?>">Pre-order</a></p></td>
		</tr>
		</table>
		 <table id="price">
		  <div id="bar">
	     <p id="pbar">Top-seller</p>
		 <a href="topseller.php" class="a1">view more [+]</a>
	   </div>
	   <div id="bar1">
	   </div>
		<tr>
	    <th><a href="Game.php?game_id=<?php echo "15";?>"><img src="<?php echo $img15;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "14";?>"><img src="<?php echo $img14;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "21";?>"><img src="<?php echo $img21;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "20";?>"><img src="<?php echo $img20;?>" width="auto" height="45%"></a></th>
		</tr>
		<tr>
		<td><p class="p1"><b><?php echo $pc15;?></b><a class="buy" href="Game.php?game_id=<?php echo "15";?>">Buy Now</a></p></td>
		<td><p class="p1"><b><?php echo $pc14;?></b><a class="buy" href="Game.php?game_id=<?php echo "14";?>">Buy Now</a></p></td>
		<td><p class="p1"><b><?php echo $pc21;?></b><a class="buy" href="Game.php?game_id=<?php echo "21";?>">Buy Now</a></p></td>
		<td><p class="p1"><b><?php echo $pc20;?></b><a class="buy" href="Game.php?game_id=<?php echo "20";?>">Buy Now</a></p></td>
		</tr>
		</table>
	 </div>
	 <div id="footer">
