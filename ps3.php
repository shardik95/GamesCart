...
(function(){
	 ...
	 <div id="main">
	   ...
	   <tr>
		...
		<th><a href="Game.php?game_id=<?php echo "8";?>"><img src="<?php echo $img8;?>" width="auto" height="45%"></a></th>
		...
		<tr>
		 ...
		 <td><p class="p1"><b><?php echo $pc8;?></b><a class="buy" href="Game.php?game_id=<?php echo "8";?>">Buy Now</a></p></td>
