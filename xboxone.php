...
(function(){
	 ...
	 <div id="main">
	   ...
	   <tr>
		...
		<!--<th><a href="Game.php?game_id=<?php echo "12";?>"><img src="<?php echo $img12;?>" width="auto" height="45%"></a></th>-->
		...
		<!-- <td><p class="p1"><b><?php echo $pc12;?></b><a class="buy" href="Game.php?game_id=<?php echo "12";?>">Buy Now</a></p></td>-->
