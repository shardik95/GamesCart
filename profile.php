<html>
   <head>
	...
	?>
	 ...
	 <table cellpadding="10" cellspacing="3.2">
		     <tr>
				...
				<td class="tr2"><a href="update.php" class="tr1">Edit Profile</a></td>
	...
	<div id="sideimg2">
		  ...
		  <div id="login2">
		  <br>
	       <p class="form1">Name:   <b><?php echo $fn." ".$Ln; ?></b>
		   <br><br>
		   Address:  <b><?php echo $add1.",".$add2; ?></b>
		   <br><br>
		   City:  <b><?php echo $city1; ?></b>
		   <br><br>
		   State:  <b><?php echo $state1; ?></b>
		   <br><br>
		   Pincode:  <b><?php echo $code; ?></b>
		   <br><br>
		   Phone no:  <b><?php echo $phone1; ?></b>
		   </p>    
