...
(function(){
	 ...
	 <div id="main">
	   ...
	   <tr>
		...
		<tr>
	 	 <td><p class="p1"><b><?php echo $pc4;?></b><a class="buy" href="Game.php?game_id=<?php echo "4";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc9;?></b><a class="buy" href="Game.php?game_id=<?php echo "9";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc10;?></b><a class="buy" href="Game.php?game_id=<?php echo "10";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc13;?></b><a class="buy" href="Game.php?game_id=<?php echo "13";?>">Buy Now</a></p></td>
         
		</tr>
		 <tr>
	    <th><a href="Game.php?game_id=<?php echo "18";?>"><img src="<?php echo $img18;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "24";?>"><img src="<?php echo $img24;?>" width="auto" height="45%"></a></th>
		
		
		</tr>
		<tr>
	 	 <td><p class="p1"><b><?php echo $pc18;?></b><a class="buy" href="Game.php?game_id=<?php echo "18";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc24;?></b><a class="buy" href="Game.php?game_id=<?php echo "24";?>">Buy Now</a></p></td>
