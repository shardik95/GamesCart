...
(function(){
	 ...
	 <div id="main">
	   ...
	   <tr>
		...
		<th><a href="Game.php?game_id=<?php echo "3";?>"><img src="<?php echo $img3;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "17";?>"><img src="<?php echo $img17;?>" width="auto" height="45%"></a></th>
		...
		<td><p class="p1"><b><?php echo $pc3;?></b><a class="buy" href="Game.php?game_id=<?php echo "3";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc17;?></b><a class="buy" href="Game.php?game_id=<?php echo "17";?>">Buy Now</a></p></td>
