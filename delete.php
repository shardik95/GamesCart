	  ...
	  if ( isset( $_POST['logout'] ) ){ 
		...
		if ( isset( $_GET['submit2'] ) ){
         ...
         if ( isset( $_POST['delete'] ) ){
			 $del="DELETE FROM user WHERE user_id='".$user_check."'";
			 if ($conn->query($del) === TRUE) {
    $ste="Record deleted successfully";
	
} else {
    $ste= "Error deleting record: " . $conn->error;
}
		 }
 ...
 <div id="wrap">
	...
	<div id="sideimg2">
		  ...
		  <br>
			...
			<input type="submit" name="delete" value="DELETE"  class="signin">
			</form>
		      <br>
			  <br>
			  <?php echo $ste; ?>
