...
(function(){
	 ...
	 <div id="main">
	   ...
	   <div id="bar1">
	     ...
	     <table id="price">
	   <tr>
	    <th><a href="Game.php?game_id=<?php echo "25";?>"><img src="<?php echo $img25;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "26";?>"><img src="<?php echo $img26;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "27";?>"><img src="<?php echo $img27;?>" width="auto" height="45%"></a></th>
		<th><a href="Game.php?game_id=<?php echo "28";?>"><img src="<?php echo $img28;?>" width="auto" height="45%"></a></th>
		</tr>
		<tr>
	 	 <td><p class="p1"><b><?php echo $pc25;?></b><a class="buy" href="Game.php?game_id=<?php echo "25";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc26;?></b><a class="buy" href="Game.php?game_id=<?php echo "26";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc27;?></b><a class="buy" href="Game.php?game_id=<?php echo "27";?>">Buy Now</a></p></td>
		 <td><p class="p1"><b><?php echo $pc28;?></b><a class="buy" href="Game.php?game_id=<?php echo "28";?>">Buy Now</a></p></td>
